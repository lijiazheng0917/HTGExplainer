            ...
            if e % 5 == 0:
                ...
                for i in range(batchs):
                    ...
                    for n in range(lo, hi):
                        ...
                        h_m = self.model_to_explain[0](masked_sg.to('cuda'),'author')
                ...
                for i in range(batchs):
                    ...
                    for n in range(lo, hi):
                        n = int(n)
                        print(n)
                        src, dst = self.G_label[1].edges()[0][n], self.G_label[1].edges()[1][n]
                ...
                auc = roc_auc_score(torch.round(target.cpu()), all_pred)
                ap = average_precision_score(torch.round(target.cpu()), all_pred)
